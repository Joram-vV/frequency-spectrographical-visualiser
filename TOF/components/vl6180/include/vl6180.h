 ...
 */
static inline vl6180_config_t vl6180_get_default_config(i2c_master_dev_handle_t dev_handle, i2c_master_bus_handle_t bus_handle)
{
    return (vl6180_config_t){
        .i2c_dev_handle = dev_handle,
        .i2c_bus_handle = bus_handle,
        .reset_gpio = GPIO_NUM_NC,
        .range_timeout_ms = 100,
